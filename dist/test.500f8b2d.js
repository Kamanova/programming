...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"test.js":[function(require,module,exports) {
"use strict";
...
var propsValues = {
  tilte: "List of dishes",
  all_dishes: ["Борщ", "Уха", "Рассольник", "Том ям", "Грибной", "Желе", "Булка", "Кекс", "Тирамису", "Цезарь", "Блинчики с мясом", "Сырная тарелка"]
};

var all_dishes = function (_React$Component) {
  _inherits(all_dishes, _React$Component);

  function all_dishes() {
    _classCallCheck(this, all_dishes);

    return _possibleConstructorReturn(this, (all_dishes.__proto__ || Object.getPrototypeOf(all_dishes)).apply(this, arguments));
  }

  _createClass(all_dishes, [{
    key: "render",
...
var all_dishesList = function (_React$Component2) {
  _inherits(all_dishesList, _React$Component2);

  function all_dishesList(props) {
    _classCallCheck(this, all_dishesList);

    var _this2 = _possibleConstructorReturn(this, (all_dishesList.__proto__ || Object.getPrototypeOf(all_dishesList)).call(this, props));

    _this2.state = { all_dishes: _this2.props.data.all_dishes };
  ...
  _createClass(all_dishesList, [{
    key: "filterList",
    value: function filterList(e) {
      var filteredList = this.props.data.all_dishes.filter(function (item) {
        return item.toLowerCase().search(e.target.value.toLowerCase()) !== -1;
      });
      // обновление состояния
      this.setState({ all_dishes: filteredList });
    }
  }, {
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "ul",
          null,
          this.state.all_dishes.map(function (item) {
  ...
  return all_dishesList;
}(_react2.default.Component);

_reactDom2.default.render(_react2.default.createElement("all_dishesList", { data: propsValues }), document.getElementById("root"));
...
//# sourceMappingURL=/test.500f8b2d.map