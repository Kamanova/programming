  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("input", { type: "text", name: "recip" }),
        _react2.default.createElement(
          "button",
          null,
          "Find"
        ),
        _react2.default.createElement("dr", null),
        _react2.default.createElement(
          "button",
          { onClick: function onClick() {
              return onChange('soups');
            } },
          "soups"
        ),
        _react2.default.createElement(
...
},{"react":"node_modules/react/index.js"}],"gallery.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("img", { src: photos[index], width: "200", height: "140" }),
        _react2.default.createElement(
          "p",
          null,
          " ",
        ...
        _react2.default.createElement(
          ...
          {
            onClick: function onClick() {
              _this2.setState({ index: (index + 1) % photos.length });
            }
          },
          "Next"
        )
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var gallery = {
        soups: ['https://changes.club/image/09/da/09da1112-e52d-405f-b866-f82c2a00c492.jpg', 'http://kulinarnaya-feya.ru/wp-content/uploads/2015/08/Uha-iz-shhuki.jpg', 'http://s4.fotokto.ru/photo/full/522/5223229.jpg', 'http://avocadocook.ru/f/product/65.jpg', 'https://5gribov.ru/wp-content/uploads/2017/09/gr_syp_opyata_1234567678-1200x750.jpg'],

        desserts: ['http://vsetiramisu.ru/wp-content/uploads/2012/11/B568336C2381431B77C28CB7B236E0.jpg', 'http://ne-dieta.ru/wp-content/uploads/2017/11/final_1200-7.jpg', 'http://testosam.ru/wp-content/uploads/2015/10/d8b2366e81fdac0fa3855070d6cd3310.jpg', 'https://100ing.ru/media/uploads/public/recept_1.jpg'],

        snacks: ['http://blog.eda.ua/wp-content/uploads/2014/09/syirnaya-tarelka.jpg', 'https://old.st.zakupka.tv/images/bb/0e/53/49ac5fd0-f674-11e5-9928-bac568a79449.jpg', 'https://carte.by/source/photos/2017/04/24/tsezar-s-kur.jpg']
      };
      var descriptions = {
        soupsDescription: ['Как у бабушки', 'Очень вкусный', 'Капец херовый', 'Сложный в приготовлении', 'Необходим опыт в приготовлении'],
        dessertDescription: ['Безумно вкусный', 'Осторожно каллории!', 'Классика', 'Дети будут в восторге'],
        snacksDescription: ['Всем знакомо', 'НЕ забудь купить мясо', 'Приготовит даже ленивый']
      };

      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_menu2.default, { onChange: function onChange(category) {
            return _this2.setState({ category: category });
          } }),
        _react2.default.createElement(
          'figure',
          null,
          'Welcome World Cuisine Recipes'
        ),
        _react2.default.createElement(
          'p',
          null,
        ...
        _react2.default.createElement(_gallery2.default, { photos: gallery[this.state.category] }),
        _react2.default.createElement(_gallery2.default, { texts: descriptions[this.state.texts] })
      );
    }
  }]);
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./menu":"menu.js","./gallery":"gallery.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '33897' + '/');
...
//# sourceMappingURL=/main.e08ab1f5.map